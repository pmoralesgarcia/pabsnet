...
<div class="card">
    ...
    <table>
        ...
        <tr>
            <td data-label="Type"><?php echo Support::e($e['type']); ?></td>
            <td data-label="Pattern"><?php echo Support::e($e['pattern']); ?></td>
            <td data-label="Note" class="muted"><?php echo Support::e($e['note']); ?></td>
            <td data-label="Added" class="muted"><?php echo Support::e($e['created_at']); ?></td>
            <td>
