...
<p class="muted">
    ...
    Public read API: <code>?target=https://yoursite.com/post</code> &middot;
    <?php if (Session::hasRole('owner')) : ?><a href="../feed.php">RSS feed</a> (token on the Settings page unless made public)<?php endif; ?>
</p>
...
<div class="card">
    ...
    <?php else : ?>
    <table>
        <tr><th>Source</th><th>Target</th><th>Status</th><th>Author</th><th>Received</th><?php if ($canAct) : ?><th></th><?php endif; ?></tr>
        <?php foreach ($entries as $m) : ?>
        <tr>
            <td data-label="Source" style="max-width:220px; overflow-wrap:anywhere;"><a href="<?php echo Support::e($m['source']); ?>" target="_blank" rel="noopener"><?php echo Support::e($m['source']); ?></a></td>
            <td data-label="Target" style="max-width:200px; overflow-wrap:anywhere;"><?php echo Support::e($m['target']); ?></td>
            <td data-label="Status"><span class="badge <?php echo $m['status'] === 'verified' ? 'ok' : ($m['status'] === 'pending' ? 'pending' : ($m['status'] === 'spam' ? 'spam' : 'bad')); ?>"><?php echo Support::e($m['status']); ?></span></td>
            <td data-label="Author"><?php echo Support::e($m['author_name']); ?></td>
            <td data-label="Received" class="muted"><?php echo Support::e($m['created_at']); ?></td>
            <?php if ($canAct) : ?>
