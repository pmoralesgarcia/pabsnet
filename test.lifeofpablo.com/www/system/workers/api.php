...
class YellowApi {
    ...
    public function getApiResponse($location) {
        ...
        if ($slug == "random") {
            ...
            $randomPage = !empty($pagesArray) ? $pagesArray[array_rand($pagesArray)] : null;
            $data = $randomPage ? $this->formatPageDataWithRelated($randomPage, $base) : ["error" => "No content found"];
        } 
    ...
    private function wrapPagination($pages, $base) {
        ...
        return ["items" => $this->buildDataArray($pages, $base)];
    }
