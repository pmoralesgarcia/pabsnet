...
<article class="athelas">
  <div class="vh-100 dt w-100 tc bg-dark-gray white cover" style="background:url(https://photos.lifeofpablo.com/north-table-mountain-ecological-reserve/DSC_0740%202.png) no-repeat center;">
    <div class="dtc v-mid">
      <header class="white-70">
        <h2 class="f6 fw1 ttu tracked mb2 lh-title">Issue Six</h2>
        <h3 class="f6 fw1 lh-title">Summer MMXVI</h3>
      </header>
      <h1 class="f1 f-headline-l fw1 i orange">California</h1>
  ...
  <div class="center measure-wide f5 pv5 lh-copy ph2">
    <h1 class="f1 lh-title">Placeholder</h1>
    <p>
